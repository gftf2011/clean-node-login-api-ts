 ...
 * Shared
 */
import { Error400, Error401, Error403, MissingHeaderParamsError, MissingParamsError } from '../../../shared/errors'

/**
 * Presentation
 */
import { badRequest, forbidden, serverError, unauthorized } from '../../helpers/http-helper'
...
export abstract class WebController implements Controller {
  ...
  public async handle (request: HttpRequest): Promise<HttpResponse> {
    try {
      ...
      const missingHeaderParams: string[] = WebController.getMissingHeaderParams(request, this.requiredHeaderParams)
